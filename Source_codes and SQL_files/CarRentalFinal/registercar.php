...
$City=$_POST["city"];
	...
	$res="SELECT * from rates where Ctype='$Ctype'";
	$result1=mysqli_query($connection,$res);
	...
	$result="INSERT INTO car(License_no,Model,Year,Ctype,Drate,Wrate) VALUES('$License_no','$Model','$Year','$Ctype','$Drate','$Wrate')";
